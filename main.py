...
Properties.set("yaml_dir", "%s/lib/tpl/yaml" % APP_ROOT)
Properties.set("jobs_dir", "%s/jobs" % APP_ROOT)
Properties.set("default_config", "%s/lib/tpl/config/properties.ini" % APP_ROOT)
Properties.set("log_dir", "%s/data/logs" % APP_ROOT)
Properties.set("lock_dir", "%s/data/lock" % APP_ROOT)
Properties.set("runner_dir", "%s/data/runner" % APP_ROOT)
Properties.set("version", Config.get('info', 'version'))
Properties.set("socket_file", Config.get('default', 'socket_file'))
Properties.set("shell", Config.get('default', 'shell'))
